...
export default function JSX02() {
  ...
  // const imgUrl = "https://cdn.pixabay.com/photo/2024/03/08/09/47/ai-generated-8620359_640.png";

  const cat = {
    catUrl: "https://cdn.pixabay.com/photo/",
    description: "2024/03/08/09/47/",
    imageId: "ai-generated-8620359_640.png",
    name: "아기고양이",
    imageTheme: {
      width: "200px",
      height: "150px",
