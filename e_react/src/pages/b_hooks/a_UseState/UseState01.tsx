...
: useState 훅 호출 시
  >> 변화되는 상태값과 해당 상태값을 업데이트 하는 함수를 제공
...
export default function UseState01() {
  ...
  return (
    <div>
      <p style={{color: 'blue'}}>useState최신 상태 관리</p>

      <p>You clicked {count} times</p>
      <button onClick={handelUpclick}>카운트를 증가시킵니다</button>
      <button onClick={handleDownClick}>카운트를 시킵니다</button>
    </div>
  );
}
