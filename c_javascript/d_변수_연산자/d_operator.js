...
console.log(`x % y = ${x % y}`);  // 1 (나머지: a % b - a를 b로 나누고 난 나머지)
...
// : 데이터의 앞에 연산자가 있을 경우 전위(바로 값을 증가)
...
//  , 결과를 참(true)과 거짓(false)로 반환 >> boolean 타입으로 반환
...
console.log(str1 < str2); // a ~ z까지 뒤로 갈수록 큰 값
