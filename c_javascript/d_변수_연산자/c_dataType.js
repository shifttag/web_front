...
//? 기본 자료형 (string, number, boolan, null & undefined)
...
// 백틱(``) : 문자열 내에 변수나 표현식을 사용할 수 있도록 하는 문자열
console.log('안녕하세요, name, 입니다');
console.log(`안녕하세요 ${name}입니다.`);

console.log(`3 + 7 = ${3 + 7}`);

// let mulitiLine = '안녕하세요
...
console.log(
  // value 변수의 타입이 'object'이면서(and) 값이 존재하지 않은 경우 'null'을 출력
...
console.log(Number(notANumber));  // NaN: Not A Number - 숫자로 변환할 수 없는 값을 변환 시도할 경우 
...
// true: false값 제외한 모든 데이터를 true로 간주
