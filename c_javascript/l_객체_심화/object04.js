...
console.log('=== or 연산자 ===');
object.name || console.log('name 속성이 없습니다'); // 출력 x
object.hobby || console.log('hobby 속성이 없습니다'); // 출력
...
console.log('=== and 연산자 ===');
object.name && console.log('name 속성이 있습니다');
object.hobby && console.log('name 속성이 있습니다');
...
object.hobby =
object.hobby !== undefined ? object.name : '취미를 알 수 없는 고객';
