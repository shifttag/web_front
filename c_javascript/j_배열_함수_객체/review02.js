...
function addToCart(id, name, price, quantity) {
  ...
  // (findIndex: 배열 내의 동일한 요소가 있는지 찾고 index를 반환 / 없으면 -1 반환)
...
function updateQuantity(id, quantity) {
  ...
  // 상품이 존재 하고 수량이 0보다 큰 경우: 상품 업데이트
...
addToCart(2, 'Cheery', 1.8, 3);
addToCart(3, 'Grape', 3.5, 1);
