...
busanLibrary.addBook('SQLD 공부', '홍동현');
busanLibrary.addBook('JS 공부', '홍동현');
busanLibrary.addBook('IoT 공부', '홍동현');
busanLibrary.addBook('Java 공부', '홍동현');
...
seoulLibrary.addBook('바나나먹기', '홍동현');
seoulLibrary.addBook('짜장면 맛있게 끓이기', '홍동현');
